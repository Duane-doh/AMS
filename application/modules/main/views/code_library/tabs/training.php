...
<?php if($action_id != ACTION_VIEW) : ?>
	  <button class="btn btn-success  md-trigger green" data-modal="modal_training" onclick="modal_training_init('<?php echo ACTION_ADD; ?>')">Add <?php echo CODE_LIBRARY_TRAINING; ?></a></button>
<?php ENDIF; ?>
</div>

<div class="pre-datatable filter-left">
	<table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="training_table">
	  <thead>
		<tr>
		...
		<tr class="table-filters">
			<td><input name="training_name" class="form-filter"></td>
