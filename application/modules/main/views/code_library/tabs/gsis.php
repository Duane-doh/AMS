<div class="col l12 m12 s12 right-align p-r-n">
	<div class="input-field inline p-l-md z-input m-t-n m-b-md">
		<?php if($this->permission->check_permission(MODULE_PAYROLL_CL_GSIS, ACTION_ADD)) :?>
			<button class="btn btn-success  md-trigger" data-modal="modal_gsis" onclick="modal_gsis_init('<?php echo ACTION_ADD; ?>')"><i class="flaticon-add176"></i> Add <?php echo STATUTORY_GSIS; ?></a></button>	
		<?php ENDIF; ?>
	</div>
</div>
<div class="pre-datatable filter-left"></div>
<div>
	<table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="gsis_table">
	  	<thead>
		  	<tr>
