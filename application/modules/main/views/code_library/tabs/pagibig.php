<div class="col l12 m12 s12 right-align p-r-n">
	<div class="input-field inline p-l-md z-input m-t-n m-b-md">
		<?php if($this->permission->check_permission(MODULE_PAYROLL_CL_PAGIBIG, ACTION_ADD)) :?>
			<button class="btn btn-success  md-trigger" data-modal="modal_pagibig" onclick="modal_pagibig_init('<?php echo ACTION_ADD ?>')"><i class="flaticon-add176"></i> Add <?php echo STATUTORY_PAGIBIG; ?></a></button>
		<?php ENDIF; ?>
	</div>
</div>
...
<div>
	<table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="pagibig_table">
	  <thead>
		<tr>
