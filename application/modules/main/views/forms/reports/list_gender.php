...
<head>
	...
	<title>Employee List by Gender</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>LIST AND NUMBER OF EMPLOYEES BY GENDER<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
		<td colspan=2 height="20" align="left" valign=top></td>
	</tr>
	<tr>
		<td colspan=2 height="15" align="left" valign=bottom><b>Sex: <?php echo strtoupper($param) ?></b></td>
