...
<head>
	...
	<title>Employee List by Age</title>
...
<table class="table-max">
	<tbody>
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>LIST AND NUMBER OF EMPLOYEES BY AGE<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
		<td colspan=2 height="20" align="left" valign=top></td>
	</tr>
	<tr>
		<td colspan=2 height="15" align="left" valign=bottom><b>Age Range: <?php echo $param ?></b></td>
...
<table class="table-max">
	<thead>		
		<tr>
			...
			<td class="td-border-light-top td-border-light-bottom td-border-light-right td-center-middle" width="100"><b>Birth Date</b></td>
		</tr>
	</thead>
	<?php if($office): ?>
				...
				<?php foreach ($records AS $record): ?>
					<?php if($record['office_id'] == $off['office_id']): ?>
						<tr>
							...
							<td class="pad-2 td-border-light-top td-border-light-bottom td-border-light-right td-center-middle"><?php echo $record['birth_date']?></td>
						</tr>
					<?php endif;?>
				<?php endforeach;?>	
			<?php else: ?>
