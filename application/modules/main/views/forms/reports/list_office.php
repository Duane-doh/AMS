...
<head>
	...
	<title>Employee List by Offices</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=5 height="50" valign=bottom><b>LIST AND NUMBER OF EMPLOYEES BY OFFICE<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
		<td colspan=3 height="20" align="left" valign=top></td>
	</tr>
	<tr>
		<td colspan=5 align="left"><b>Count: <?php echo (!EMPTY($records)) ? count($records) : 0?></b></td>
	</tr>
</table>
<table class="table-max">
	<thead>
				...
				<?php foreach ($records AS $record): ?>
					<?php if($record['office_id'] == $off['office_id']): ?>
						<tr>
							...
							<td class="pad-2 td-border-light-bottom td-border-light-top td-border-light-right"><?php echo strtoupper($record['service_status'])?></td>
						</tr>
					<?php endif;?>
				<?php endforeach;?>
			<?php else: ?>
				<tr>
					<td colspan="5" class="td-border-light-top td-border-light-bottom td-border-light-left td-border-light-right td-center-middle" height="30"><b>No Records Found.</b></td>
				</tr>
			<?php endif;?>
		<?php endforeach;?>	
	<?php else: ?>
