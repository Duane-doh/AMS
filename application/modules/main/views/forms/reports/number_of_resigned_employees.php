...
<head>
	...
	<title>Number of Resigned Employees</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>NUMBER OF RESIGNED EMPLOYEES<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
				...
				<?php foreach ($records AS $record): ?>
					<?php if($record['office_id'] == $off['office_id']): ?>
						<tr>
							...
							<td class="pad-2 td-border-light-bottom td-border-light-top td-border-light-right" align="center"><?php echo strtoupper($record['employ_end_date'])?></td>
						</tr>
					<?php endif;?>
				<?php endforeach;?>
			<?php else: ?>
