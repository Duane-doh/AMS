...
<head>
	...
	<title>Employee List by Salary Grade</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>LIST AND NUMBER OF EMPLOYEES BY SALARY GRADE<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
		<td colspan=2 height="20" align="left" valign=top></td>
	</tr>
	<tr>
		<td colspan=2 height="15" align="left" valign=bottom><b>Salary Grade: <?php echo $sg ?></b></td>
		...
		<?php foreach ($office as $off): ?>
			...
			<?php if($records): ?>
				<?php foreach ($records AS $record): ?>
					<?php if($off['office_id'] == $record['office_id']): ?>
						<tr>
