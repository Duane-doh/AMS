...
<head>
	...
	<title>Employee List by Employment Status</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>LIST AND NUMBER OF EMPLOYEES BY EMPLOYMENT STATUS<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
		<td colspan=2 height="20" align="left" valign=top></td>
	</tr>
	<tr>
		<td colspan=2 height="15" align="left" valign=bottom><b>Employment Status: <?php echo strtoupper(!EMPTY($records[0]['employment_status_name']) ? $records[0]['employment_status_name'] : $status['employment_status_name']); ?></b></td>
