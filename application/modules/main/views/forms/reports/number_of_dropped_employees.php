...
<head>
	...
	<title>Number of Employees Dropped From The Roll</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>NUMBER OF EMPLOYEES DROPPED FROM THE ROLL<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
