...
<head>
	...
	<title>GSIS Certificate of Contribution</title>
...
<div  style="margin: 5mm">
	...
	<table class="f-size-12">
		...
		<tr>
			<td colspan=5 height="40" align="justify" valign=middle><p><?php echo nbs(10) ?>This is to certify that according to the records of this Office the Government Service 
			Insurance System (GSIS), <?php echo $deduction['deduction_name'] ?> deducted from the salaries of <b> <?php echo $label?> <?php echo $employee_info['employee_name']?> (<?php echo $employee_info['other_deduction_detail_value']?>)</b> 
			of the <?php echo $office_name ?>, this Department were remitted to GSIS are as follows:
			</p></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan=1 height="20" class="td-border-top td-border-bottom td-border-right" align="center" valign=middle><?php echo ($deduction['employer_share_flag'] == YES) ? 'PERSONAL SHARE':'AMOUNT' ?> </td>
			<?php if($deduction['employer_share_flag'] == YES): ?>
