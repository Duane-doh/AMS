...
<head>
	...
	<title>Pagibig Certificate of Contribution</title>
...
<div  style="margin: 5mm">
	...
	<table class="f-size-12">
		...
		<tr>
			<td colspan=5 height="21" class="bold f-size-16" align="center" valign=middle style="font-size: 16pt">C E R T I F I C A T I O N</td>
		</tr>
		<tr>
			<td colspan=5 height="30"></td>
		</tr>
		<tr>
			<td colspan=5 height="40" align="justify" valign=middle><p><?php echo nbs(10) ?>This is to certify that according to the records of this Office the PAG-IBIG CONTRIBUTION deducted from the salaries of <b> <?php echo $label?> <?php echo $employee_info['employee_name']?> (<?php echo $employee_info['other_deduction_detail_value']?>)</b> 
			of the <?php echo $office_name ?>, this Department were remitted to Pag-IBIG(Home Development Mutual Fund) are as follows:
			</p></td>
		</tr>
		<tr>
		...
		<?php if($records): ?>
			<?php foreach ($records as $record): ?>
				<tr>
					...
					<td colspan=1 height="20" class="td-border-top td-border-bottom td-border-right" align="center" valign=middle>&#8369; <?php echo number_format($record['amount'],2); ?></td>
					<td colspan=1 height="20" class="td-border-top td-border-bottom td-border-right" align="center" valign=middle>&#8369; <?php echo number_format($record['employer_amount'],2); ?></td>
					<td colspan=1 height="20" class="td-border-top td-border-bottom td-border-right" align="center" valign=middle><?php echo strtoupper($record['or_no']); ?></td>
					<td colspan=1 height="20" class="td-border-top td-border-bottom td-border-right" align="center" valign=middle><?php echo format_date($record['or_date'],'m/d/Y'); ?></td>
				</tr>
			<?php endforeach;?>
		<?php else: ?>
		<tr>
