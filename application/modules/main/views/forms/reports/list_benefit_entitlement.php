...
<head>
	...
	<title>Employee List by Benefit Entitlement</title>
...
<table class="table-max">
	<tr>
		<td class="td-center-bottom f-size-12" colspan=4 height="50" valign=bottom><b>LIST AND NUMBER OF PERSONNEL BY BENEFIT ENTITLEMENT<br><?php echo $date_hdr ?></b></td>
	</tr>
	<tr>
		<td colspan=2 height="20" align="left" valign=top></td>
	</tr>
	<tr>
		<td colspan=2 height="15" align="left" valign=bottom><b>Benefit Entitlement: <?php echo strtoupper(!EMPTY($records[0]['compensation_name']) ? $records[0]['compensation_name'] : $benefit['compensation_name']); ?></b></td>
	...
	<table class="table-max">
		<thead>
			<tr>
				...
				<td class="td-border-light-top td-border-light-bottom td-border-light-right td-center-middle" width="250"><b>Employee Name</b></td>
				<td class="td-border-light-top td-border-light-bottom td-border-light-right td-center-middle" width="250"><b>Position</b></td>
				<td class="td-border-light-top td-border-light-bottom td-border-light-right td-center-middle" width="100"><b>Position Level</b></td>
			</tr>		
		</thead>
		...
		<?php if($office): ?>
			<?php foreach ($office as $off): ?>
				<tr>
					<td class="border-light pad-2" colspan=4 height="20" align="left" valign=middle><b>OFFICE: <?php echo strtoupper($off['office'])?></b></td>
				</tr>
				<?php if($records): ?>
					<?php foreach ($records AS $record): ?>
						<?php if($record['office_id'] == $off['office_id']): ?>
							<tr>
								...
								<td class="pad-2 td-border-light-top td-border-light-bottom td-border-light-right"><?php echo strtoupper($record['position_level_name'])?></td>
							</tr>
						<?php endif;?>
					<?php endforeach;?>
				<?php else: ?>
