    ...
    <section id="content" class="p-t-n m-t-n ">
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                <ol class="breadcrumb m-n p-b-sm">
                    ...
                    <li><a class="active">Contract Record<?php //echo SUB_MENU_SR; ?></a></li>
                </ol>
                <h5 class="breadcrumbs-title">Contract Record<?php //echo SUB_MENU_SR; ?></h5>
              </div>
            </div>
          </div>
        </div>
      ...
      <!--start section-->
          		<div class="pre-datatable filter-left"></div>
        			<div>
        			  <table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="table_contract_record">
          			  <thead>
          				<tr>
