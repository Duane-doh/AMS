...
<div class="p-t-lg">
	<table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="table_process_history">
	  	<thead>
			<tr>
			...
			<tr class="table-filters">
				<td><input name="B-processed_by" class="form-filter"></td>
				<td><input name="A-hist_date" class="form-filter"></td>
