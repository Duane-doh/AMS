...
<div class="col s12 p-r-sm right-align m-b-n-l-lg">
    ...
    <button class="btn btn-success  md-trigger" type="button" data-modal="modal_employee_statutory" onclick="modal_employee_statutory_init('<?php echo ACTION_ADD."/".$employee_id ?>')"><i class="flaticon-add175"></i> Add Statutory Deduction</button>
     <?php endif;?>
  </div>
 </div>
 <?php endif;?>
...
<div style="padding:50px 12px 0px 0px">
  <table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="table_statutory_details">
    <thead> 
    <tr>
