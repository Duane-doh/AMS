    	...
    	<!--start section-->
    		<div id="article_tab teal">
    			<div class=" row teal">
    			 	<div class="col s12 ">
    			      <ul class="tabs teal">
    			        <li class="tab col s4 active"><a href="<?php echo base_url() . PROJECT_MAIN ."/compensation/get_tab/employee_list/";?>">Employee List</a></li>
    			        <li class="tab col s5"><a href="<?php echo base_url() . PROJECT_MAIN ."/compensation/get_tab/compensation_type_list/";?>">Benefit List</a></li>
    			      </ul>
    			    </div>
...
$(function (){
	...
	$('#tab_content').load('<?php echo base_url() . PROJECT_MAIN ."/compensation/get_tab/employee_list/".$action."/".$id."/".$token."/".$salt."/".$module;?>')
