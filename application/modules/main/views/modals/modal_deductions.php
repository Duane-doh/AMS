<form id="role_form">
		...
		<div class="row">
		  <div class="col s6">
			<div class="input-field">
			  <label for="loan_type" class="active">Deductions Type</label>
			  <select id="loan_type" <?php echo $action_id==ACTION_VIEW ? 'disabled' : '' ?> class="selectize" placeholder="Select Loan">
				<option value="">Select Loan</option>
				<option value="1">GSIS</option>
				<option value="2">HDMF</option>
			  </select>
			</div>
		  </div>
		  <div class="col s6">
			<div class="input-field">
			  ...
			  <select id="frequency" <?php echo $action_id==ACTION_VIEW ? 'disabled' : '' ?> class="selectize" placeholder="Select Loan">
				<option value="">Select Loan</option>
				<option value="1">GSIS</option>
				<option value="2">HDMF</option>
			  </select>
	...
	<div class="row <?php echo $action_id ==ACTION_VIEW ? 'none' : '' ?>">
		<div class="row p-l-sm"><label class="dark font-md">Deduction Scope</label></div>
