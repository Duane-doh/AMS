<!--  
General Payroll List -> Process -> Deduction List (tab) -> Edit 
-->
...
<form id="payroll_process_form">
	...
	<div class="form-float-label">
		<div class="row p-md">
			<span class="font-lg font-spacing-15"><?php echo !empty($deduction_name) ? $deduction_name : '';?></span>
		</div>
	
	  <div>
		<div class="pre-datatable filter-left"></div>
	    <div class="col s12">
		  <table cellpadding="0" cellspacing="0" class="table table-advanced table-layout-auto" id="table_deduction_process">
		  <thead>
			<tr>
			...
			<tr class="table-filters">
				...
				<td><input name="C-remarks_deduction" class="form-filter"></td>
