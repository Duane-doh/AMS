...
class Number_of_promoted_employees extends Main_Controller {
	...
	public function generate_report_data( $param = NULL, $office = NULL, $date = NULL)
	{
		try
		{
			...
			$select_fields   = array();
			$select_fields[] = 'DATE_FORMAT(B.employ_start_date, "%Y/%m/%d") employ_start_date';
			...
			$where                        																		= array();
			$where['B.employ_personnel_movement_id']  															= array($value, array('IN'));
...
/* End of file Number_of_promoted_employees.php */
/* Location: ./application/modules/main/controllers/reports/hr/Number_of_promoted_employees.php */