...
class List_employment_status extends Main_Controller {
...
EOS;
			...
			$field                    	   = array("employment_status_name");
			$table                    	   = $this->rm->tbl_param_employment_status;
			$where                    	   = array();
			$where['employment_status_id'] = $param;
			$data['status']      	 	   = $this->rm->get_reports_data($field, $table, $where, FALSE);
...
/* End of file List_employment_status.php */
/* Location: ./application/modules/main/controllers/reports/hr/List_employment_status.php */