...
class List_position_title extends Main_Controller {
...
EOS;
			...
			$tables 		= array(
				...
				'alias'     => 'G',
				'type'      => 'LEFT JOIN',
				'condition' => 'B.employ_plantilla_id = G.plantilla_id'
			 	),
				't8'        => array(
			...
			$where 						  																		= array();
			$where['B.employ_position_id'] 																		= $param;
			...
			$where                    	= array();
			$where['position_id'] 		= $param;
			$data['position']      	 	= $this->rm->get_reports_data($field, $table, $where, FALSE);
		}
