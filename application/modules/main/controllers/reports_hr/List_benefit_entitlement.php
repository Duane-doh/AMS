...
class List_benefit_entitlement extends Main_Controller {
...
EOS;
			...
			$table                    = $this->rm->tbl_param_compensations;
			$where                    = array();
			$where['compensation_id'] = $param;
			$data['benefit']      	  = $this->rm->get_reports_data($field, $table, $where, FALSE);
...
/* En	d of file List_benefit_entitlement.php */
/* Location: ./application/modules/main/controllers/reports/hr/List_benefit_entitlement.php */