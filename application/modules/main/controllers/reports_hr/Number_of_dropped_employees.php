...
class Number_of_dropped_employees extends Main_Controller {
	...
	public function generate_report_data( $param = NULL, $office = NULL, $date = NULL)
	{
		try
		{
			...
			// $where['B.employ_start_date']                     													= array($date_from, array(">="));
			// $where["IFNULL(B.employ_end_date, IF('".$date_to."' < current_date,'".$date_to."',current_date))"] 	= array($date_to, array('<='));
...
/* End of file Number_of_dropped_employees.php */
/* Location: ./application/modules/main/controllers/reports/hr/Number_of_dropped_employees.php */