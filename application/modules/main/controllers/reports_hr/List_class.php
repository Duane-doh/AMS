...
class List_class extends Main_Controller {
...
EOS;
			...
			$select_fields[] = 'B.employ_salary_grade as salary_grade';
			...
			$field                    		  = array("position_class_level_name");
			$table                    		  = $this->rm->tbl_param_position_class_levels;
			$where                    		  = array();
			$where['position_class_level_id'] = $param;
			$data['class']      	 		  = $this->rm->get_reports_data($field, $table, $where, FALSE);
...
/* End of file List_class.php */
/* Location: ./application/modules/main/controllers/reports/hr/List_class.php */