...
class Number_of_retirees extends Main_Controller {
	...
	public function generate_report_data( $param = NULL, $office = NULL, $date = NULL)
	{
		try
		{
			...
			$where                        	= array();
			$where['B.separation_mode_id']  = array($value, array('IN'));
...
/* End of file Number_of_retirees.php */
/* Location: ./application/modules/main/controllers/reports/hr/Number_of_retirees.php */