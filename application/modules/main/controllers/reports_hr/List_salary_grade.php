...
class List_salary_grade extends Main_Controller {
...
EOS;
			...
			$select_fields[] = 'B.employ_salary_grade salary_grade';
			...
			$where 						  																		= array();
			$where['B.employ_salary_grade']      																= $param;
			$where['B.employ_type_flag']  																		= array(array(DOH_JO, DOH_GOV_APPT, DOH_GOV_NON_APPT), array('IN'));
			if($prepared_by == REGULAR_PERMANENT) {
...
/* End of file List_salary_grade.php */
/* Location: ./application/modules/main/controllers/reports/hr/List_salary_grade.php */