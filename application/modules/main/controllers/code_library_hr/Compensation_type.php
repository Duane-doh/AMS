...
class Compensation_type extends Main_Controller {
	private $module = MODULE_HR_CL_COMPENSATION_TYPE;
	...
	public function initialize($action_id = NULL, $id = NULL, $salt = NULL, $token = NULL)
	{
		...
		try
		{
			...
			$resources['datatable'][] 		= array('table_id' => 'compensation_type_table', 'path' => 'main/code_library_hr/compensation_type/get_compensation_type_list', 'advanced_filter' => TRUE);
			$resources['load_modal']  		= array(
				'modal_compensation_type' 	=> array(
					'controller'			=> 'code_library_hr/compensation_type',
					'module'				=> PROJECT_MAIN,
			...
			$resources['load_delete'] 		= array(
				'code_library_hr/compensation_type',
				'delete',
				PROJECT_MAIN
			);
	...
	public function get_compensation_type_list()
	{
		try
		{
			...
			$aColumns					= array("compensation_id", "compensation_name", "compensation_code", "IF(active_flag = 'Y', 'Active', 'Inactive') as active_flag");
	...
	public function delete()
	{
		...
		$info 					= array(
			...
			"path"				=> PROJECT_MAIN . '/code_library_hr/compensation_type/get_compensation_type_list/',
...
/* Location: ./application/modules/main/controllers/code_library_hr/Compensation_type.php */