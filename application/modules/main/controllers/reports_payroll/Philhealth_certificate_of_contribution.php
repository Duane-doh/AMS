...
class Philhealth_certificate_of_contribution extends Main_Controller {
	...
	public function generate_report_data($params)
	{
		try
		{
			...
			$data            		= array();			
			$data['records'] 		= $this->rm->get_philhealth_certificate_of_contribution_list($param, $office, $date);
			$deduc_code_param 		= 'CERT_PHILHEALTH_CODE';
...
/* End of file Philhealth_certificate_of_contribution.php */
/* Location: ./application/modules/main/controllers/reports/hr/Philhealth_certificate_of_contribution.php */