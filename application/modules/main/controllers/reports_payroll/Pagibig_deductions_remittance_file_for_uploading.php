...
class Pagibig_deductions_remittance_file_for_uploading extends Main_Controller {
	...
	public function generate_report_data($params)
	{
		try
		{
			...
			$data['pagibig_deduc_remittances']  = $this->rm->get_pagibig_contributions_remittance_list($date_range_from, $date_range_to, $report_name, $payroll_type_ids);
...
/* End of file Pagibig_deductions_remittance_file_for_uploading.php */
