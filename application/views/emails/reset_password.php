...
<div style="width:85%; margin:0 auto;">
  <div style="background:#00796B; margin-bottom: -5px;"><img src="<?php echo base_url() . PATH_IMAGES ?>email_header.png" height="100%" width="100%" alt="logo" /></div>
  <div style="background:#f6f6f6; padding:30px;">
	<p style="font-size:14px; font-family:'Open Sans', arial;margin:10px 0 20px; line-height:25px;">
	  The <?php echo $system_name ?> has received a request to reset the password for your account, <?php echo $email ?>.
	</p>
