		...
		if(args.apnd_type !== undefined) {
			...
			switch(args.apnd_type.toLowerCase()) {
				...
				case 'append':
					...
					tbl_copy.before(tbl_copy).clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style').append(container);
				...
				case 'prepend':
					...
					tbl_copy.before(tbl_copy).clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style').prepend(container);
				...
				case 'appendto':
					...
					tbl_copy.before(tbl_copy).clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style').appendTo(container);
				...
				case 'prependto':
					...
					tbl_copy.before(tbl_copy).clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style').prependTo(container);
				...
				case 'after':
					...
					if( args.not_table )
					{
						container.after( tbl_copy.clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style') );
					}
					else 
					{
						if( $( self ).parents( 'table' ).length !== 0 )
						{
							$( self ).parents( 'tr' ).after( tbl_copy.clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style') );
						}
						else
						{
							tbl.find( 'tbody' ).append( tbl_copy.clone().attr('id', tbl_id+'_row_'+row_index).removeAttr('style') );
						}
					}
